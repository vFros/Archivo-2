...
namespace Esx_Deliveries_Client
{
    public class Client : BaseScript
    {
        ...
        public Client()
        {
            ...
            DeliveryData.DELIVERIES_REWARD_SCOOTER      = GetConvarInt("esx_deliveries_reward_scooter", 35);
            DeliveryData.DELIVERIES_REWARD_VAN          = GetConvarInt("esx_deliveries_reward_van", 75);
            DeliveryData.DELIVERIES_REWARD_TRUCK        = GetConvarInt("esx_deliveries_reward_truck", 125);

            DeliveryData.SAFE_DEPOSIT_SCOOTER           = GetConvarInt("esx_deliveries_safe_deposit_scooter", 350);
            DeliveryData.SAFE_DEPOSIT_VAN               = GetConvarInt("esx_deliveries_safe_deposit_van", 550);
            DeliveryData.SAFE_DEPOSIT_TRUCK             = GetConvarInt("esx_deliveries_safe_deposit_truck", 850);
