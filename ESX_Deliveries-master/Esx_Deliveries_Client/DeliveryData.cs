...
namespace Esx_Deliveries_Client
{
    class DeliveryData
    {
        ...
        {
            ["DELIVERY_NOT_AVAILABLE"] = "Este modo ~r~No esta habilitado~w~ aun. Porfavor utilice la ~g~Motocicleta~w~ o la ~g~Van~w~.",
            ["START_DELIVERY"] = "Presiona ~INPUT_CONTEXT~ para comenzar el trabajo en ruta. Deberas colocar un deposito de ~g~$",
            ["SAFE_DEPOSIT_RECEIVED"] = "A sido cobrado un seguro en tu cuenta bancaria.",
            ["SAFE_DEPOSIT_RETURNED"] = "El vehiculo a llegado en buen estado. El dinero del seguro regresa a tu cuenta.",
            ["SAFE_DEPOSIT_WITHHELD"] = "Entrega ~r~fallida~w~. El vehiculo del seguro a sido ~r~retenido~w~ por el banco.",
            ["DELIVERY_POINT_REWARD"] = "Entrega completada. Has recibido ~g~$",
            ["GET_BACK_IN_VEHICLE"] = "Entra al vehiculo!",
            ["REMOVE_GOODS"] = "Presiona ~INPUT_CONTEXT~ para retirar ~y~La entrega~w~.",
            ["DELIVER_INSIDE_SHOP"] = "Anda a la tienda para entregar ~y~El objeto~w~.",
            ["GET_BACK_TO_DELIVERYHUB"] = "Regrese al centro de entrega para devolver el vehículo.",
            ["DELIVERY_VEHICLE_RETURNED"] = "El vehiculo de entregas a regresado.",
            ["END_DELIVERY"] = "Presiona ~INPUT_CONTEXT~ para finalizar el trabajo. Asegurate de estar dentro del vehiculo para recibir el dinero del seguro.",
        };
